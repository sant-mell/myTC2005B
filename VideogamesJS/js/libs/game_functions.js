...
function boxOverlap(obj1, obj2) {
    ...
    const R1 = obj1.collider.x + collider.width;
    const T1 = obj1.collider.y;
    const B1 = obj1.collider.y + collider.height;

    const L2 = obj2.collider.x;
    const R2 = obj2.collider.x + collider.width;
    const T2 = obj2.collider.y;
    const B2 = obj2.collider.y + collider.height;
